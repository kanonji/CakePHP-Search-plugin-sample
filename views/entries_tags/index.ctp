<div class="entriesTags index">
	<h2><?php __('Entries Tags');?></h2>
	...
	<?php
	$i = 0;
	foreach ($entriesTags as $entriesTag):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $entriesTag['EntriesTag']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $entriesTag['EntriesTag']['created']; ?>&nbsp;</td>
		<td><?php echo $entriesTag['EntriesTag']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $entriesTag['EntriesTag']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $entriesTag['EntriesTag']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $entriesTag['EntriesTag']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $entriesTag['EntriesTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
